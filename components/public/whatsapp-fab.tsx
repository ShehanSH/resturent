...
export function WhatsAppFab({ number }: { number: string | null }) {
  ...
  return (
    <a
      ...
      className="fixed right-4 bottom-24 z-50 inline-flex size-14 items-center justify-center rounded-2xl bg-[#25D366] text-white shadow-[0_8px_24px_-4px_rgba(18,140,70,0.6)] ring-1 ring-black/5 transition-all duration-200 hover:scale-105 hover:shadow-[0_12px_32px_-4px_rgba(18,140,70,0.7)] md:bottom-6"
